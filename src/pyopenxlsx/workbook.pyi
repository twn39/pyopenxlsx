...
class Workbook:
    ...
    def __init__(self, filename: Optional[str] = None, force_overwrite: bool = True) -> None: ...
    def save(self, filename: Optional[str] = None, force_overwrite: bool = True) -> None: ...
    async def save_async(self, filename: Optional[str] = None, force_overwrite: bool = True) -> None: ...
    def close(self) -> None: ...
    ...
    def create_sheet(self, title: Optional[str] = None, index: Optional[int] = None) -> Worksheet: ...
    async def create_sheet_async(self, title: Optional[str] = None, index: Optional[int] = None) -> Worksheet: ...

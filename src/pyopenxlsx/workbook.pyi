...
class Workbook:
    ...
    def save(
        self, filename: Optional[str] = None, force_overwrite: bool = True, password: Optional[str] = None
    ) -> None: ...
...
async def load_workbook_async(filename: str, password: Optional[str] = None) -> Workbook: ...

...
void init_comments(py::module_& m) {
    ...
    py::class_<XLThreadedComments>(m, "XLThreadedComments")
        .def(py::init<>())
        .def("comment", &XLThreadedComments::comment, "ref"_a)
        .def("replies", &XLThreadedComments::replies, "parent_id"_a)
        .def("add_comment", &XLThreadedComments::addComment, "ref"_a, "person_id"_a,
             "text"_a)
        .def("add_reply", &XLThreadedComments::addReply, "parent_id"_a, "person_id"_a,
             "text"_a)
        .def("delete_comment", &XLThreadedComments::deleteComment, "ref"_a);
    ...
    py::class_<XLPersons>(m, "XLPersons")
        .def(py::init<>())
        .def("person", &XLPersons::person, "id"_a)
        .def("add_person", &XLPersons::addPerson, "display_name"_a);
}
